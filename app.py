...
# Description des datasets
    ...
    if st.checkbox("_Afficher valeurs manquantes de la table **Mobilisations**_") :
        st.image("Images/valeurs_manquantes_df_mobilisations.jpg", caption="Variables à plus 10% de valeurs manquantes", width=600)
...
# DataVizualisation
    ...
    st.image("Images/Distribution_variable_cible.jpg", caption="Distribution des temps d'attente (variable cible)", width=700)

    st.image("Images/Distribution_gamma_variable_cible.jpg", caption=" La variable cible ne suit pas une distribution Gamma malgré les apparences", width=700)

    st.image("Images/Distribution_variable_cible_hue.jpg", caption="Distribution des temps d'attente par type d'incident (variable cible)", width=700)



    st.markdown("<h2 style='text-align: center; color: black;'>Types d'interventions</h2>", unsafe_allow_html=True)

    st.image("Images/Boxplot_temps_attente_type_intervention.jpg", caption="Temps d'attente par type d'intervention", width=1400)

    st.image("Images/Mobilisations_Description_Pie.jpg", caption="Description des différents types de mobilisation", width=1000)

    st.image("Images/Mobilisations_Incidents.jpg", caption="Nombre de mobilisations par incidents", width=600)



    st.markdown("<h2 style='text-align: center; color: black;'>Evolution temporelle</h2>", unsafe_allow_html=True)

    st.image("Images/Nb_mobilisations_mensuelles_diachronique.jpg", caption="Evolution mensuelle du nombre d'appels", width=1300)

    st.image("Images/Distribution_nb_appels_heure.jpg", caption="Distribution du nombre d'appels par heure", width=1500)

    st.image("Images/Distribution_nb_appels_jour_mois.jpg", caption="Distribution du nombre d'appels par jour et par mois", width=1500)

    st.image("Images/Distribution_nb_appels_an_moti.jpg", caption="Distribution du nombre d'appels par année et par motif", width=1100)
    ...
    st.image("Images/Carte_Londres.jpg", caption='Carte de Londres avec, en rouge, les casernes les plus sollicitées et en vert les casernes les moins sollicitées', width=1500)

    st.image("Images/Carte_Londres_distances_casernes.jpg", caption="Carte de Londres avec, en rouge, les casernes avec les distances parcourues les plus longues et en vert les casernes les distances parcourues les moins longues", width=1500)

    st.image("Images/Carte_Londres_attendance_time_casernes.jpg", caption="Carte de Londres avec, en rouge, les casernes avec les temps d'attente les plus long et en vert les casernes les moins longs", width=1500)
